...
<div id="toast-success"
    class="fixed animate-slideupMsg top-3 right-1/2 translate-x-1/2 md:right-8 md:translate-x-0 z-10 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white border border-gray-200 rounded-lg shadow-lg  shadow-gray-200/70 dark:text-gray-400 dark:bg-gray-800"
    role="alert">
    <div
    ...
    <div class="ms-3 text-sm font-normal">{{ Session::get('success') }}Data berhasil ditambahkan</div>
    <button type="button"
...
<section class="p-3 sm:p-5 antialiased">
    <h2 class="text-xl font-medium ml-4 mb-4">Post by: {{ Auth::user()->name }}</h2>
    <div class=" max-w-screen-xl px-4">
        <div class="bg-white dark:bg-gray-800 relative border sm:rounded-lg overflow-hidden mb-4">
            <div class="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    {{-- bagian 'action' dikosongin biar isi inputan dikirim dan ditangkap di halaman ini sendiri --}}
                    <form class="flex items-center" action="" method="GET">
                        <label for="post-search" class="sr-only">Search post</label>
                        <div class="relative w-full">
                            ...
                            <input type="text" id="post-search" name="keyword"
                ...
                <div
                    ...
                    <a href="/dashboard/create" id="createProductModalButton" data-modal-target="createProductModal1"
