                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            x-transition:enter-start="opacity-0 scale-65" x-transition:enter-end="opacity-100 scale-100"
                            x-transition:leave="transition ease-in duration-75 transform"
                            x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-65"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Zaki Ramadhan</div>
                    <div class="text-sm font-medium text-gray-400">zakiram4dhan@gmail.com</div>
                </div>
            </div>
