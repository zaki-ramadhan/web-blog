...
{
    protected $user_type; //protected agar bisa digunakan di class ini saja
    /**
    ...
    {
        // mengecek dari inputan 'user_cred' apakah user mencoba masuk menggunakan username atau email
